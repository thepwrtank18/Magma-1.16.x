...
public class CraftEventFactory {
     ...
     * BlockFadeEvent
     */
    public static BlockFadeEvent callBlockFadeEvent(IWorld world, BlockPosition pos, IBlockData newBlock) {
    ...
    public static BlockPhysicsEvent callBlockPhysicsEvent(IWorld world, BlockPosition blockposition) {

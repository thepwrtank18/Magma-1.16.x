...
public final class CraftEnderChest extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.EnderChest, org.bukkit.block.data.Directional, org.bukkit.block.data.Waterlogged {
    ...
    private static final net.minecraft.state.EnumProperty<?> FACING = getEnum(EnderChestBlock.class, "facing");
    ...
    private static final net.minecraft.state.BooleanProperty WATERLOGGED = getBoolean(EnderChestBlock.class, "waterlogged");

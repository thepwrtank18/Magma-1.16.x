...
public final class CraftHopper extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.Hopper, org.bukkit.block.data.Directional {
    ...
    private static final net.minecraft.state.BooleanProperty ENABLED = getBoolean(net.minecraft.server.BlockHopper.class, "enabled");
    ...
    private static final net.minecraft.state.EnumProperty<?> FACING = getEnum(net.minecraft.server.BlockHopper.class, "facing");

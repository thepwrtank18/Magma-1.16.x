...
public final class CraftBed extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.Bed, org.bukkit.block.data.Directional {
    ...
    private static final net.minecraft.state.EnumProperty<?> PART = getEnum(BedBlock.class, "part");
    private static final net.minecraft.state.BooleanProperty OCCUPIED = getBoolean(BedBlock.class, "occupied");
    ...
    private static final net.minecraft.state.EnumProperty<?> FACING = getEnum(BedBlock.class, "facing");
